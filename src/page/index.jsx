...
function Paper() {
    ...
    return (
        <>
            ...
            {showTranslateCard && <TranaslateCard open={showTranslateCard} setOpen={setShowTranslateCard} highlihghtedContent={selections} setGlbTranslateTo={setGlbTranslateTo} setHighlightedContent={setSelections}/>}
